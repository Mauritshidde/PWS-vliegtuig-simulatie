...
void createLiftFiles(int steps, float precisionFactor, float stepSize); // steps has to be greater than 2 but realisticly has to be higher than 200 and lower than 1000 for perfomance reasons
